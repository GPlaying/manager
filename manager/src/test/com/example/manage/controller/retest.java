...
public class Repairtest {
    ...
    public void repair1(){
        ...
        //进行维修
        workersController.working(repairTable, worker);
        Assert.assertEquals(worker.getStatus(), 1);

        workersController.finished(repairTable);
        RepairTableRecord repairTableRecord = repairTableRecordController.findById(repairId).get();
        Assert.assertEquals(repairTableRecord.getWorker_name(), workername);
